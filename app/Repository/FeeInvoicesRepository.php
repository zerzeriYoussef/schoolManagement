...
class FeeInvoicesRepository implements FeeInvoicesRepositoryInterface
{
    ...
    if ($StudentAccount) {
        ...
        // Handle the case where no student account is found
        // For example, you might want to log an error or return a message
        return redirect()->back()->withErrors(['error' => 'Student account not found for the given fee invoice ID.']);
    }
            DB::commit();
