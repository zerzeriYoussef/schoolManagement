...
@section('content')
                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($sections as $list_Sections)
                                                                    <tr>
                                                                        <?php $i++; ?>
                                                                        <td>{{ $i }}</td>
                                                                        <td>{{ $list_Sections->getTranslation('Name_Section', app()->getLocale()) }}</td>
    ...
    <select name="Grade_id" class="custom-select" id="GradeSelect">
        <!--placeholder-->
    ...
    <div class="col">
                                            ...
                                            <option value="" selected disabled>{{ trans('Sections_trans.teacher') }}</option>
...
<div class="col">
    ...
    <select name="Class_id" class="custom-select" id="ClassSelect">
        <option value="" selected disabled>{{ trans('Sections_trans.Select_Class') }}</option>
        <!-- Options will be filled dynamically by AJAX -->
    </select>
</div>
    ...
    $(document).ready(function () {
        $('#GradeSelect').on('change', function () {
            ...
            if (gradeId) {
                $.ajax({
                    url: '{{ route("getClasses", ":id") }}'.replace(':id', gradeId),
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
                        $('#ClassSelect').empty();
                        $('#ClassSelect').append('<option value="" disabled selected></option>');
