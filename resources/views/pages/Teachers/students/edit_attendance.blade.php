...
<div class="modal fade" id="edit_attendance{{$student->id}}_{{ $matier->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            @csrf
                    ...
                    <input type="hidden" name="mati" value="{{ $matier->id }}">
